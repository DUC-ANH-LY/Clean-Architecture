...
/**
 * MongoDB implementation of InventoryRepoI.
 * Uses atomic $inc operator to safely reduce stock quantity.
...
public class MongoInventoryRepoImpl implements InventoryRepoI {
    ...
    public void reduceStock(String productId, int quantity) {
        ...
        var result = mongoTemplate.updateFirst(query, update,
                com.example.ecommerce.infra.persistence.nosql.spring.document.ProductDocument.class);
