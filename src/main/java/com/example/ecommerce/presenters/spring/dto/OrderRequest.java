package com.example.ecommerce.presenters.spring.dto;
...
/**
 * HTTP Request DTO for the Spring REST controller.
 * Converts from HTTP JSON body → core CreateOrderRequestModel.
 */
